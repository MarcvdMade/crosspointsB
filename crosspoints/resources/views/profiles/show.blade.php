        ...
        <h4>Rechten die u heeft:</h4>
            @can('is_admin')
                <div class="card-body login-body">
                    ...
                    <a class="text-decoration-none text-white" href="{{route('admin')}}"><button class="btn btn-dark admin-show-btn">Admin Pagina</button></a>
                </div>
            @endcan
            ...
            @can('is_counselor')
                <div class="card-body login-body">
                    ...
                    <a class="text-decoration-none text-white" href="{{route('vertrouwenspersoon')}}"><button class="btn btn-dark admin-show-btn">Vertrouwenspersoon Pagina</button></a>
                </div>
            @endcan
